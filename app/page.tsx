...
class VerticalMouseDrivenCarousel {
  ...
  constructor(options: Partial<typeof this.defaults> = {}) {
    ...
    <div className="page-container">
      ...
      <header className="header">
        <div className="contact">
          <img className="media" src="https://devicon-website.vercel.app/api/linkedin/plain.svg?color=%23FFFFFF" alt="LinkedIn" onClick={() => window.open("https://www.linkedin.com/in/alexandre-manceau-068a98280/", "_blank")} />
          <img className="media" src="https://devicon-website.vercel.app/api/github/original-wordmark.svg?color=%23FFFFFF" alt="GitHub" onClick={() => window.open("https://github.com/DevinciAlex", "_blank")} />
          <img className="media" src="/img/mail.png" alt="Mail" onClick={() => window.open("mailto:alexandre.manceau@edu.devinci.fr", "_blank")} />
        </div>
      </header>
